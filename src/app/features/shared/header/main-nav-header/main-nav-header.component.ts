...
@Component({
  ...
  *ngFor="let item of navigationItems"
  ...
  [class]="isActive(item) ? 'bg-[#1b8354] text-white px-4 py-2 rounded-md [outline:2px_solid_#fff0!important] hover:bg-[#1b8354] ' : 'text-gray-900 hover:bg-gray-200 bg-gray-0 '"
